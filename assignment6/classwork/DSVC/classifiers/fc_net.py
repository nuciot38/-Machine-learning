...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3*32*32, hidden_dim=100, num_classes=10,
        ...
        #使用np.random.normal函数来生成指定大小的矩阵，标准差是weight_scale
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        self.use_dropout = dropout > 0 #当dropout<=0时为false
        self.reg = reg
        self.num_layers = 1 + len(hidden_dims) #在loss()中用神经网络的层数来标记规模
        self.dtype = dtype
        self.params = {} #空字典保存待训练学习的参数
